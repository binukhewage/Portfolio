...
import {SiMysql, SiTailwindcss, SiMongodb, SiExpress, SiNextdotjs } from 'react-icons/si';
...
const projects = [
  {
    title: 'GOAT CULT',
    description: 'Full-stack streetwear e-commerce platform built using the MERN stack with Stripe/PayPal integration and admin dashboard.',
  ...
  {
    title: 'ORAGAN',
    description: "Official website for ORAGAN, built with Next.js showcasing the company's mission, services, and products.",
  ...
  return (
    <div className="text-white">
      ...
      >
          ...
          <div className="flex flex-col xl:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <motion.p 
                ...
                variants={item}
              >
                Passionate Full Stack Developer with hands-on experience in web development and design.
              </motion.p>
        ...
        {/* Scroll Indicator */}
        <motion.div
          className="flex flex-col items-center mt-4 mb-8 xl:mb-0"
    ...
    <div className="w-4 h-8 border-2 border-accent/50 rounded-full flex justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {about.info.map((item, index) => (
                  <motion.div 
                    ...
                    whileHover={{ x: 5 }}
                  >
                    <span className="text-accent font-mono">{item.fieldName}:</span>
      ...
      >
        <div className="container mx-auto px-6">
          <motion.div 
            ...
            variants={slideUp}
          >
            <h2 className="text-4xl font-bold mb-4">My <span className="text-accent">Skills</span></h2>
            <p className="text-white/70 max-w-2xl mx-auto">Through my academic journey and hands-on experience, I've developed a strong skill set in web development and design.</p>
          </motion.div>
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <motion.p className="text-white/70 max-w-2xl mx-auto mb-16 text-center">Building full-stack solutions with real-world impact, from sleek front-ends to robust back-ends.</motion.p>
